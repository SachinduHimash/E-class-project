                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                RaisedButton(
                                  ...
                                  onPressed: () { 
                                    var marks =0;
                                    if(AnswerPage40.answer.indexOf(0) == -1){
                                      AnswerPage40.qNumber = null;
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Expanded(
                              ...
                              child: RaisedButton(
                                  color: AnswerPage40.answer[qNumber-1] == 1 ?  Colors.green[400] : Colors.amber,
                                  onPressed: () {
                                    setState(() {
                                      AnswerPage40.answer[qNumber-1] = 1;
                                    });
                                  },
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Expanded(
                              ...
                              padding: EdgeInsets.symmetric(horizontal: 20,vertical: 5),
                              child:RaisedButton(
                                  color: AnswerPage40.answer[qNumber-1] == 2 ?  Colors.green[400] : Colors.amber,
                                  onPressed: () {
                                    setState(() {
                                      AnswerPage40.answer[qNumber-1] = 2;
                                    });
                                  },
                                  padding: EdgeInsets.symmetric(vertical: 15,horizontal: 15),
                                    child: Text(
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Expanded(
                              ...
                              padding: EdgeInsets.symmetric(horizontal: 20,vertical: 5),
                              child:RaisedButton(
                              color: AnswerPage40.answer[qNumber-1] == 3 ?  Colors.green[400] : Colors.amber,
                              onPressed: () {
                                setState(() {
                                  AnswerPage40.answer[qNumber-1] = 3;
                                });
                              },
                              padding: EdgeInsets.symmetric(vertical: 15,horizontal: 15),
                              child: Text(
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            Expanded(
                              ...
                              padding: EdgeInsets.symmetric(horizontal: 20,vertical: 5),
                              child: RaisedButton(
                              color: AnswerPage40.answer[qNumber-1] == 4 ?  Colors.green[400] : Colors.amber,
                              onPressed: () {
                                setState(() {
                                  AnswerPage40.answer[qNumber-1] = 4;
                                });
                              },
                              padding: EdgeInsets.symmetric(vertical: 15,horizontal: 15),
                              child: Text(
